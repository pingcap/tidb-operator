...
require (
	...
	github.com/pingcap/advanced-statefulset/client v1.17.1-0.20231124094705-00595b4ef4ac
...
replace github.com/tikv/pd/client => github.com/HuSharp/pd/client v0.0.0-20231208071038-9ada30d08673
