...
require (
	...
	github.com/pingcap/TiProxy/lib v0.0.0-20230112135018-320c0c023d5f
	...
	github.com/pingcap/tidb-operator/pkg/apis v1.4.0
	github.com/pingcap/tidb-operator/pkg/client v1.4.0
