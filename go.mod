...
require (
	...
	github.com/pingcap/tidb-operator/pkg/apis v1.6.2
	github.com/pingcap/tidb-operator/pkg/client v1.6.2
	github.com/pingcap/tiproxy/lib v0.0.0-20250701105009-506b723175e3
