...
import (
	...
	pingcapcomv1 "github.com/pingcap/tidb-operator/new-operator/pkg/apis/pingcap.com/v1"
	versioned "github.com/pingcap/tidb-operator/new-operator/pkg/client/clientset/versioned"
	internalinterfaces "github.com/pingcap/tidb-operator/new-operator/pkg/client/informers/externalversions/internalinterfaces"
	v1 "github.com/pingcap/tidb-operator/new-operator/pkg/client/listers/pingcap.com/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.PingcapV1().TidbClusters(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PingcapV1().TidbClusters(namespace).Watch(options)
			},
		},
		&pingcapcomv1.TidbCluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *tidbClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&pingcapcomv1.TidbCluster{}, f.defaultInformer)
}

func (f *tidbClusterInformer) Lister() v1.TidbClusterLister {
	return v1.NewTidbClusterLister(f.Informer().GetIndexer())
}
