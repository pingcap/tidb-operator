...
> **Note:**
>
> Due to [this issue of Kubernetes](https://github.com/kubernetes/kubernetes/issues/78420), the Kubernetes cluster must meet one of the following versions to enable `HostNetwork` of TiDB cluster:
>  - `v1.13.11` or later
>  - `v1.14.7` or later
>  - `v1.15.4` or later
>  - any version since `v1.16.0`

[#1175](https://github.com/pingcap/tidb-operator/pull/1175) add `podSecurityContext` support for TiDB cluster Pods, we recommend setting the namespaced kernel parameters for TiDB cluster Pods according to our [Environment Recommendation](https://pingcap.com/docs/dev/tidb-in-kubernetes/deploy/prerequisites/#the-configuration-of-kernel-parameters).
...
- HostNetwork support ([#1202](https://github.com/pingcap/tidb-operator/pull/1202))
...
For historical reason, `v1.1.0.alpha` is an hot-fix branch and got this name by mistake. All fixes in that branch are cherry-picked to `v1.0.4` and the `v1.1.0.alpha` branch will be discarded to keep things clear.
...
- HostNetwork support ([#1202](https://github.com/pingcap/tidb-operator/pull/1202))
- Add permit host option for tidb-initializer job ([#779](https://github.com/pingcap/tidb-operator/pull/779))
- Fix drainer misconfiguration in tidb-cluster chart ([#945](https://github.com/pingcap/tidb-operator/pull/945))
- Set the default externalTrafficPolicy to be Local for TiDB service ([#960](https://github.com/pingcap/tidb-operator/pull/960))
- Fix tidb-operator crash when user modify sts upgrade strategy improperly ([#969](https://github.com/pingcap/tidb-operator/pull/969))
- Add maxFailoverCount limit to TiKV ([#976](https://github.com/pingcap/tidb-operator/pull/976))
...
- Suspend ReplaceUnhealthy process for AWS tikv auto-scaling-group ([#1027](https://github.com/pingcap/tidb-operator/pull/1027))
- Fix create_tidb_cluster_release variable does not work ([#1066](https://github.com/pingcap/tidb-operator/pull/1066)))
