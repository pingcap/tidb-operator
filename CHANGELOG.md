...
For historical reason, `v1.1.0.alpha` is an hot-fix branch and got this name by mistake. All fixes in that branch are cherry-picked to `v1.0.4` and
the `v1.1.0.alpha` branch will be discarded to keep things clear.
