...
func (s *state) Object() *v1alpha1.TiKVWorker {
	return s.tikvworker
}

func (s *state) SetObject(tikvworker *v1alpha1.TiKVWorker) {
	s.tikvworker = tikvworker
}

func (s *state) TiKVWorker() *v1alpha1.TiKVWorker {
	return s.tikvworker
}
...
func (s *state) Instance() *runtime.TiKVWorker {
	return runtime.FromTiKVWorker(s.tikvworker)
}
