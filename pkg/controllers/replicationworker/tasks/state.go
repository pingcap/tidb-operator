...
type State interface {
	common.ContextObjectNewer[*v1alpha1.ReplicationWorker]
	common.ContextClusterNewer[*v1alpha1.ReplicationWorker]
	common.ObjectState[*v1alpha1.ReplicationWorker]

	common.ClusterState
	common.PodState
	common.PodStateUpdater

	common.InstanceState[*runtime.ReplicationWorker]

	common.StatusUpdater
	common.StatusPersister[*v1alpha1.ReplicationWorker]
...
func NewState(key types.NamespacedName) State {
	...
	s.IFeatureGates = stateutil.NewFeatureGates[scope.ReplicationWorker](s)
	return s
}
...
func (s *state) Object() *v1alpha1.ReplicationWorker {
	return s.replicationWorker
}

func (s *state) ReplicationWorker() *v1alpha1.ReplicationWorker {
	return s.replicationWorker
}
...
func (s *state) Instance() *runtime.ReplicationWorker {
	return runtime.FromReplicationWorker(s.replicationWorker)
}
...
func (s *state) SetObject(rw *v1alpha1.ReplicationWorker) {
	s.replicationWorker = rw
}
