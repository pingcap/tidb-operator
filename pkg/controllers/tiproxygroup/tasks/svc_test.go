...
func TestTaskService(t *testing.T) {
	cases := []struct {
		...
		},
		{
			...
			objs: []client.Object{
				fake.FakeObj[corev1.Service]("aaa-tiproxy-peer"),
			},
		...
		},
		{
			...
			objs: []client.Object{
				fake.FakeObj[corev1.Service]("aaa-tiproxy"),
			},
		...
		},
		{
			...
			objs: []client.Object{
				newHeadlessService(fake.FakeObj[v1alpha1.TiProxyGroup]("aaa")),
			},
			unexpectedErr: true,
		...
		},
		{
			...
			objs: []client.Object{
				newHeadlessService(fake.FakeObj[v1alpha1.TiProxyGroup]("aaa")),
				newInternalService(fake.FakeObj[v1alpha1.TiProxyGroup]("aaa")),
			},
			unexpectedErr: true,
	...
	for i := range cases {
		...
		t.Run(c.desc, func(tt *testing.T) {
			...
			fc := client.NewFakeClient(c.state.TiProxyGroup())
