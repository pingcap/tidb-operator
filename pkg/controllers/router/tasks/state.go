...
type State interface {
	common.ContextObjectNewer[*v1alpha1.Router]
	common.ContextClusterNewer[*v1alpha1.Router]
	common.ObjectState[*v1alpha1.Router]

	common.ClusterState
	common.PodState
	common.PodStateUpdater

	common.InstanceState[*runtime.Router]

	common.StatusUpdater
	common.StatusPersister[*v1alpha1.Router]
...
func NewState(key types.NamespacedName) State {
	s := &state{key: key}
	s.IFeatureGates = stateutil.NewFeatureGates[scope.Router](s)
	return s
}
...
func (s *state) Object() *v1alpha1.Router {
	return s.router
}

func (s *state) SetObject(router *v1alpha1.Router) {
	s.router = router
}

func (s *state) Router() *v1alpha1.Router {
	return s.router
}
...
func (s *state) Instance() *runtime.Router {
	return runtime.FromRouter(s.router)
}
