...
import (
	...
	"github.com/pingcap/tidb-operator/pkg/controllers/br/manager/testutils"
...
func TestClean(t *testing.T) {
	...
	for _, backup := range genValidBRBackups() {
		...
		statusUpdater := backupMgr.NewRealBackupConditionUpdater(deps.Clientset, deps.BackupLister, deps.Recorder)
