...
func (in *TSO) IsAvailable(minReadySeconds int64, now time.Time) (bool, time.Duration) {
...
func (in *TSO) ServerLabels() map[string]string {
	return nil
}
...
func (g *TSOGroup) Progressing() bool {
