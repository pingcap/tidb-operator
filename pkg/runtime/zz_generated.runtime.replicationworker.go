...
func (in *ReplicationWorker) IsNotRunning() bool {
...
func (in *ReplicationWorker) IsAvailable(minReadySeconds int64, now time.Time) bool {
	cond := meta.FindStatusCondition(in.Status.Conditions, v1alpha1.CondReady)
	if cond == nil {
		return false
	}
...
func (in *ReplicationWorker) Volumes() []v1alpha1.Volume {
...
func (in *ReplicationWorker) PVCOverlay() []v1alpha1.NamedPersistentVolumeClaimOverlay {
	if in.Spec.Overlay == nil {
		return nil
	}
...
func (in *ReplicationWorker) SetImage(image string) {
...
func (g *ReplicationWorkerGroup) SetImage(image string) {
...
func (g *ReplicationWorkerGroup) MinReadySeconds() int64 {
	if g.Spec.MinReadySeconds == nil {
		return v1alpha1.DefaultReplicationWorkerMinReadySeconds
	}
	return *g.Spec.MinReadySeconds
}

func (g *ReplicationWorkerGroup) SchedulePolicies() []v1alpha1.SchedulePolicy {
