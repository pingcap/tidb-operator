...
func (in *TiKV) IsAvailable(minReadySeconds int64, now time.Time) (bool, time.Duration) {
	return isTiKVAvailable(in.Status.Conditions, in.GetGeneration(), minReadySeconds, now)
}
...
func (in *TiKV) ServerLabels() map[string]string {
...
func (g *TiKVGroup) Volumes() []v1alpha1.Volume {
...
func (g *TiKVGroup) SetTemplateClusterTLS(ca, certKeyPair string) {
...
func (g *TiKVGroup) Progressing() bool {
