...
func (in *Scheduler) IsAvailable(minReadySeconds int64, now time.Time) (bool, time.Duration) {
...
func (in *Scheduler) ServerLabels() map[string]string {
	return nil
}
...
func (g *SchedulerGroup) Volumes() []v1alpha1.Volume {
...
func (g *SchedulerGroup) Progressing() bool {
