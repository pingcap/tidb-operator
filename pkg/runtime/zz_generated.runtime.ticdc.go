...
func (in *TiCDC) IsAvailable(minReadySeconds int64, now time.Time) (bool, time.Duration) {
...
func (in *TiCDC) ServerLabels() map[string]string {
	return nil
}
...
func (g *TiCDCGroup) Volumes() []v1alpha1.Volume {
...
func (g *TiCDCGroup) MinReadySeconds() int64 {
	if g.Spec.MinReadySeconds == nil {
		return v1alpha1.DefaultTiCDCMinReadySeconds
	}
...
func (g *TiCDCGroup) Progressing() bool {
