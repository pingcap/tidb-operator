...
type rawPVCModifier struct {
	deps  *controller.Dependencies
	pm    PodVolumeModifier
	utils *volCompareUtils
}

func newRawPVCModifier(deps *controller.Dependencies) *rawPVCModifier {
	return &rawPVCModifier{
		deps:  deps,
...
func (p *rawPVCModifier) modifyVolumes(ctx *componentVolumeContext) error {
...
func (p *rawPVCModifier) tryToRecreateSTS(ctx *componentVolumeContext) error {
...
func (p *rawPVCModifier) tryToModifyPVC(ctx *componentVolumeContext) error {
...
func (p *rawPVCModifier) evictLeader(tc *v1alpha1.TidbCluster, pod *corev1.Pod) error {
...
func (p *rawPVCModifier) endEvictLeader(tc *v1alpha1.TidbCluster, pod *corev1.Pod) error {
	if isLeaderEvicting(pod) {
		pod = pod.DeepCopy()
