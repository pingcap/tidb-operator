...
func (m *tidbInitManager) makeTiDBInitJob(ti *v1alpha1.TidbInitializer) (*batchv1.Job, error) {
	...
	podLabels := util.CombineStringMap(initLabel, ti.Spec.Labels)
	podAnnotations := util.CopyStringMap(ti.Spec.Annotations)
...
func getInitMeta(ti *v1alpha1.TidbInitializer) (metav1.ObjectMeta, label.Label) {
	...
	objMeta := metav1.ObjectMeta{
		...
		Labels:      initLabel,
		Annotations: util.CopyStringMap(ti.Spec.Annotations),
	}
