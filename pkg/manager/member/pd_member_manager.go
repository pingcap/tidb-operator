...
func (pmm *pdMemberManager) syncPDServerCerts(tc *v1alpha1.TidbCluster) error {
	...
	if tc.Spec.TLSCluster.AutoGenerated != nil {
		hostList = append(hostList, tc.Spec.TLSCluster.AutoGenerated.ExtraSANDomainList...)
		ipList = append(ipList, tc.Spec.TLSCluster.AutoGenerated.ExtraSANIPList...)
	}
