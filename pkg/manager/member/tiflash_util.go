...
func setTiFlashCommonConfigDefault(config *v1alpha1.CommonConfig, externalClusterName string, clusterName, ns, clusterDomain string) {
	...
	setTiFlashFlashConfigDefault(config.Flash, externalClusterName, clusterName, ns, clusterDomain)
...
func setTiFlashFlashConfigDefault(config *v1alpha1.Flash, externalClusterName string, clusterName, ns, clusterDomain string) {
