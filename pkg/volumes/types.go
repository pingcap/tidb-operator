...
//go:generate ${GOBIN}/mockgen -write_command_comment=false -copyright_file ${BOILERPLATE_FILE} -destination mock_generated.go -package=volumes ${GO_MODULE}/pkg/volumes Modifier,ModifierFactory
package volumes
