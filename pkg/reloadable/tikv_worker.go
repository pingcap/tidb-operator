...
// CheckTiKVWorker returns whether changes are reloadable. No change also means reloadable.
...
func CheckTiKVWorker(group *v1alpha1.TiKVWorkerGroup, instance *v1alpha1.TiKVWorker) bool {
	groupTmpl := &group.Spec.Template
	instanceTmpl := templateFromTiKVWorker(instance)

	return equalTiKVWorkerTemplate(groupTmpl, instanceTmpl) &&
		features.Reloadable(meta.ComponentTiKVWorker, group.Spec.Features, instance.Spec.Features)
}

// CheckTiKVWorkerPod returns whether changes are reloadable. No change also means reloadable.
...
func CheckTiKVWorkerPod(instance *v1alpha1.TiKVWorker, pod *corev1.Pod) bool {
	...
	tmpl := &v1alpha1.TiKVWorkerTemplate{}
	...
	return equalTiKVWorkerTemplate(instanceTmpl, tmpl) &&
		features.Reloadable(meta.ComponentTiKVWorker, instance.Spec.Features, decodeFeatures(lastFeatures))
}

func EncodeLastTiKVWorkerTemplate(instance *v1alpha1.TiKVWorker, pod *corev1.Pod) error {
...
func MustEncodeLastTiKVWorkerTemplate(instance *v1alpha1.TiKVWorker, pod *corev1.Pod) {
	if err := EncodeLastTiKVWorkerTemplate(instance, pod); err != nil {
		panic("cannot encode tikv worker template: " + err.Error())
	}
}

// TODO: ignore inherited labels and annotations
func templateFromTiKVWorker(w *v1alpha1.TiKVWorker) *v1alpha1.TiKVWorkerTemplate {
	return &v1alpha1.TiKVWorkerTemplate{
		ObjectMeta: v1alpha1.ObjectMeta{
			Labels:      w.Labels,
			Annotations: w.Annotations,
		},
		Spec: w.Spec.TiKVWorkerTemplateSpec,
	}
}

// convertTiKVWorkerTemplate will ignore some fields
// TODO: set default for some empty fields
func convertTiKVWorkerTemplate(tmpl *v1alpha1.TiKVWorkerTemplate) *v1alpha1.TiKVWorkerTemplate {
...
func equalTiKVWorkerTemplate(c, p *v1alpha1.TiKVWorkerTemplate) bool {
	p = convertTiKVWorkerTemplate(p)
	c = convertTiKVWorkerTemplate(c)
