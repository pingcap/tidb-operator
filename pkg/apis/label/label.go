...
const (
	...
	// AnnGracefulShutdownTiCDCBeginTime is pod annotation key to indicate the begin time for graceful shutdown TiCDC
	AnnGracefulShutdownTiCDCBeginTime = "tidb.pingcap.com/gracefulShutdownTiCDCBeginTime"
