...
func (in *TiDBProbe) DeepCopyInto(out *TiDBProbe) {
	*out = *in
	if in.StatusAPI != nil {
		in, out := &in.StatusAPI, &out.StatusAPI
		*out = new(TiDBStatusAPIAction)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TiDBStatusAPIAction) DeepCopyInto(out *TiDBStatusAPIAction) {
	*out = *in
	if in.Host != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TiDBStatusAPIAction.
func (in *TiDBStatusAPIAction) DeepCopy() *TiDBStatusAPIAction {
	if in == nil {
		return nil
	}
	out := new(TiDBStatusAPIAction)
