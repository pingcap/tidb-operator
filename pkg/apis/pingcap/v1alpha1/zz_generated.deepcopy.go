...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DiskRequests) DeepCopyInto(out *DiskRequests) {
	*out = *in
	if in.StorageClassName != nil {
		in, out := &in.StorageClassName, &out.StorageClassName
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DiskRequests.
func (in *DiskRequests) DeepCopy() *DiskRequests {
	if in == nil {
		return nil
	}
	out := new(DiskRequests)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TiFlashSpec) DeepCopyInto(out *TiFlashSpec) {
	*out = *in
	...
	if in.DiskRequests != nil {
		in, out := &in.DiskRequests, &out.DiskRequests
		*out = make([]DiskRequests, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
