...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TLSAssetKey) DeepCopyInto(out *TLSAssetKey) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TLSAssetKey.
func (in *TLSAssetKey) DeepCopy() *TLSAssetKey {
	if in == nil {
		return nil
	}
	out := new(TLSAssetKey)
