...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OldDeploymentStorageStatus) DeepCopyInto(out *OldDeploymentStorageStatus) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OldDeploymentStorageStatus.
func (in *OldDeploymentStorageStatus) DeepCopy() *OldDeploymentStorageStatus {
	if in == nil {
		return nil
	}
...
func (in *TidbMonitorStatus) DeepCopyInto(out *TidbMonitorStatus) {
	*out = *in
	if in.OldDeploymentStorageStatus != nil {
