...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TiKVComponentReadPoolConfig) DeepCopyInto(out *TiKVComponentReadPoolConfig) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TiKVComponentReadPoolConfig.
func (in *TiKVComponentReadPoolConfig) DeepCopy() *TiKVComponentReadPoolConfig {
	if in == nil {
		return nil
	}
	out := new(TiKVComponentReadPoolConfig)
	in.DeepCopyInto(out)
	return out
}
