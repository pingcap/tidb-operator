...
func (in *TiCIMetaSpec) DeepCopyInto(out *TiCIMetaSpec) {
	*out = *in
	...
	if in.TiDBAuth != nil {
		in, out := &in.TiDBAuth, &out.TiDBAuth
		*out = new(TiCITiDBAuth)
		(*in).DeepCopyInto(*out)
	}
	if in.StorageClassName != nil {
		in, out := &in.StorageClassName, &out.StorageClassName
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TiCITiDBAuth) DeepCopyInto(out *TiCITiDBAuth) {
	*out = *in
	if in.PasswordSecret != nil {
		in, out := &in.PasswordSecret, &out.PasswordSecret
		*out = new(v1.SecretKeySelector)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TiCITiDBAuth.
func (in *TiCITiDBAuth) DeepCopy() *TiCITiDBAuth {
	if in == nil {
		return nil
	}
	out := new(TiCITiDBAuth)
