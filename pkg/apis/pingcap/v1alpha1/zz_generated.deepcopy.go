...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CustomizedReadinessProbe) DeepCopyInto(out *CustomizedReadinessProbe) {
	*out = *in
	if in.Args != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CustomizedReadinessProbe.
func (in *CustomizedReadinessProbe) DeepCopy() *CustomizedReadinessProbe {
	if in == nil {
		return nil
	}
	out := new(CustomizedReadinessProbe)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TiDBSpec) DeepCopyInto(out *TiDBSpec) {
	*out = *in
	...
	if in.CustomizedReadinessProbe != nil {
		in, out := &in.CustomizedReadinessProbe, &out.CustomizedReadinessProbe
		*out = new(CustomizedReadinessProbe)
		(*in).DeepCopyInto(*out)
	}
	return
