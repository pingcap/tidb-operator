...
import (
	...
	metricutil "github.com/pingcap/pd/pkg/metricutil"
	typeutil "github.com/pingcap/pd/pkg/typeutil"
...
func (in *PDConfig) DeepCopyInto(out *PDConfig) {
	*out = *in
	...
	out.TsoSaveInterval = in.TsoSaveInterval
	if in.Metric != nil {
		in, out := &in.Metric, &out.Metric
		*out = new(metricutil.MetricConfig)
		**out = **in
	}
	if in.Schedule != nil {
	...
	out.TickInterval = in.TickInterval
	out.ElectionInterval = in.ElectionInterval
	if in.PreVote != nil {
	...
	if in.LabelProperty != nil {
		...
		*out = new(PDLabelPropertyConfig)
		if **in != nil {
			in, out := *in, *out
			*out = make(map[string][]PDStoreLabel, len(*in))
			for key, val := range *in {
	...
	if in.WarningMsgs != nil {
		in, out := &in.WarningMsgs, &out.WarningMsgs
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.nextRetryDelay != nil {
		in, out := &in.nextRetryDelay, &out.nextRetryDelay
		*out = new(time.Duration)
		**out = **in
	}
	if in.disableStrictReconfigCheck != nil {
		in, out := &in.disableStrictReconfigCheck, &out.disableStrictReconfigCheck
		*out = new(bool)
		**out = **in
	}
	out.heartbeatStreamBindInterval = in.heartbeatStreamBindInterval
	out.LeaderPriorityCheckInterval = in.LeaderPriorityCheckInterval
	return
}
...
func (in *PDReplicationConfig) DeepCopyInto(out *PDReplicationConfig) {
	*out = *in
	...
	if in.LocationLabels != nil {
		...
		*out = make(typeutil.StringSlice, len(*in))
		copy(*out, *in)
	}
...
func (in *PDScheduleConfig) DeepCopyInto(out *PDScheduleConfig) {
	*out = *in
	...
	out.SplitMergeInterval = in.SplitMergeInterval
	out.PatrolRegionInterval = in.PatrolRegionInterval
	out.MaxStoreDownTime = in.MaxStoreDownTime
	if in.LeaderScheduleLimit != nil {
		in, out := &in.LeaderScheduleLimit, &out.LeaderScheduleLimit
		*out = new(uint64)
		**out = **in
