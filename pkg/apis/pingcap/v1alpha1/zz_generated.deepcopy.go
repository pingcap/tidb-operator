...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StorageRequests) DeepCopyInto(out *StorageRequests) {
	*out = *in
	if in.StorageClassName != nil {
		in, out := &in.StorageClassName, &out.StorageClassName
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StorageRequests.
func (in *StorageRequests) DeepCopy() *StorageRequests {
	if in == nil {
		return nil
	}
	out := new(StorageRequests)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TiFlashSpec) DeepCopyInto(out *TiFlashSpec) {
	*out = *in
	...
	if in.StorageRequests != nil {
		in, out := &in.StorageRequests, &out.StorageRequests
		*out = make([]StorageRequests, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
