...
func (in *DMDiscoverySpec) DeepCopyInto(out *DMDiscoverySpec) {
	*out = *in
	if in.CommonComponentSpec != nil {
		in, out := &in.CommonComponentSpec, &out.CommonComponentSpec
		*out = new(CommonComponentSpec)
		(*in).DeepCopyInto(*out)
	}
	in.ResourceRequirements.DeepCopyInto(&out.ResourceRequirements)
...
func (in *MasterSpec) DeepCopyInto(out *MasterSpec) {
	*out = *in
	in.CommonComponentSpec.DeepCopyInto(&out.CommonComponentSpec)
	in.ResourceRequirements.DeepCopyInto(&out.ResourceRequirements)
	if in.Service != nil {
...
func (in *TiProxySpec) DeepCopyInto(out *TiProxySpec) {
	*out = *in
	...
	if in.Proxy != nil {
		in, out := &in.Proxy, &out.Proxy
		*out = new(config.ProxyServerOnline)
		**out = **in
	}
	if in.StorageVolumes != nil {
		in, out := &in.StorageVolumes, &out.StorageVolumes
