...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PiTROverriddenConfig) DeepCopyInto(out *PiTROverriddenConfig) {
	*out = *in
	if in.GCRatioThreshold != nil {
		in, out := &in.GCRatioThreshold, &out.GCRatioThreshold
		*out = new(float64)
		**out = **in
	}
	return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PiTROverriddenConfig.
func (in *PiTROverriddenConfig) DeepCopy() *PiTROverriddenConfig {
	if in == nil {
		return nil
	}
	out := new(PiTROverriddenConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PiTRStatus) DeepCopyInto(out *PiTRStatus) {
	*out = *in
	if in.OriginConfigMap != nil {
		in, out := &in.OriginConfigMap, &out.OriginConfigMap
		*out = new(PiTROverriddenConfig)
		(*in).DeepCopyInto(*out)
	}
	return
