...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LocalTSOConfig) DeepCopyInto(out *LocalTSOConfig) {
	*out = *in
	if in.EnableLocalTSO != nil {
		in, out := &in.EnableLocalTSO, &out.EnableLocalTSO
		*out = new(bool)
		**out = **in
	}
	if in.DCLocation != nil {
		in, out := &in.DCLocation, &out.DCLocation
		*out = new(string)
		**out = **in
	}
	return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LocalTSOConfig.
func (in *LocalTSOConfig) DeepCopy() *LocalTSOConfig {
	if in == nil {
		return nil
	}
	out := new(LocalTSOConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PDConfig) DeepCopyInto(out *PDConfig) {
	*out = *in
	...
	if in.LocalTSO != nil {
		in, out := &in.LocalTSO, &out.LocalTSO
		*out = new(LocalTSOConfig)
		(*in).DeepCopyInto(*out)
	}
	if in.Metric != nil {
