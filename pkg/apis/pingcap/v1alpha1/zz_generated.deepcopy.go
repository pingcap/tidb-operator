...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MulticlusterDNSSpec) DeepCopyInto(out *MulticlusterDNSSpec) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MulticlusterDNSSpec.
func (in *MulticlusterDNSSpec) DeepCopy() *MulticlusterDNSSpec {
	if in == nil {
		return nil
	}
	out := new(MulticlusterDNSSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TidbClusterSpec) DeepCopyInto(out *TidbClusterSpec) {
	*out = *in
	...
	if in.MulticlusterDNS != nil {
		in, out := &in.MulticlusterDNS, &out.MulticlusterDNS
		*out = new(MulticlusterDNSSpec)
		**out = **in
	}
