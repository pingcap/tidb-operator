...
type TidbClusterInterface interface {
	Create(*v1alpha2.TidbCluster) (*v1alpha2.TidbCluster, error)
	Update(*v1alpha2.TidbCluster) (*v1alpha2.TidbCluster, error)
	UpdateStatus(*v1alpha2.TidbCluster) (*v1alpha2.TidbCluster, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha2.TidbCluster, error)
	List(opts v1.ListOptions) (*v1alpha2.TidbClusterList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha2.TidbCluster, err error)
...
func newTidbClusters(c *PingcapV1alpha2Client, namespace string) *tidbClusters {
	return &tidbClusters{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *tidbClusters) Get(name string, options v1.GetOptions) (result *v1alpha2.TidbCluster, err error) {
	result = &v1alpha2.TidbCluster{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *tidbClusters) List(opts v1.ListOptions) (result *v1alpha2.TidbClusterList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha2.TidbClusterList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("tidbclusters").
...
func (c *tidbClusters) Create(tidbCluster *v1alpha2.TidbCluster) (result *v1alpha2.TidbCluster, err error) {
	result = &v1alpha2.TidbCluster{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("tidbclusters").
...
func (c *tidbClusters) Update(tidbCluster *v1alpha2.TidbCluster) (result *v1alpha2.TidbCluster, err error) {
	result = &v1alpha2.TidbCluster{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tidbclusters").
...
func (c *tidbClusters) UpdateStatus(tidbCluster *v1alpha2.TidbCluster) (result *v1alpha2.TidbCluster, err error) {
	result = &v1alpha2.TidbCluster{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tidbclusters").
...
func (c *tidbClusters) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha2.TidbCluster, err error) {
	result = &v1alpha2.TidbCluster{}
