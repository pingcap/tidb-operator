...
var tidbngmonitoringsResource = v1alpha1.SchemeGroupVersion.WithResource("tidbngmonitorings")

var tidbngmonitoringsKind = v1alpha1.SchemeGroupVersion.WithKind("TidbNGMonitoring")
