...
var volumerestoresResource = v1alpha1.SchemeGroupVersion.WithResource("volumerestores")

var volumerestoresKind = v1alpha1.SchemeGroupVersion.WithKind("VolumeRestore")
