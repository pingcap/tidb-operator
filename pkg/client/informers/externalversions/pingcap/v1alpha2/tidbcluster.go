...
import (
	...
	v1alpha2 "github.com/pingcap/tidb-operator/pkg/client/listers/pingcap/v1alpha2"
...
type TidbClusterInformer interface {
	...
	Lister() v1alpha2.TidbClusterLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PingcapV1alpha2().TidbClusters(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PingcapV1alpha2().TidbClusters(namespace).Watch(options)
			},
		},
		&pingcapv1alpha2.TidbCluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *tidbClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&pingcapv1alpha2.TidbCluster{}, f.defaultInformer)
}

func (f *tidbClusterInformer) Lister() v1alpha2.TidbClusterLister {
	return v1alpha2.NewTidbClusterLister(f.Informer().GetIndexer())
}
