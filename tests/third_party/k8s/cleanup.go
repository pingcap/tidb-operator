...
// this file is a copy of the file in k8s.io/kubernetes/test/e2e/framework/cleanup.go @v1.23.17
...
func RunCleanupActions() {
	...
	// Run unlocked.
	for _, fn := range list {
		log.Logf("Running Cleanup Action: %v", runtime.FuncForPC(reflect.ValueOf(fn).Pointer()).Name())
		fn()
	}
}
