...
import (
	...
	v1beta1 "github.com/pingcap/tidb-operator/tests/pkg/apiserver/client/listers/example/v1beta1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ExampleV1beta1().Pods(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ExampleV1beta1().Pods(namespace).Watch(options)
			},
		},
		&examplev1beta1.Pod{},
		resyncPeriod,
...
func (f *podInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&examplev1beta1.Pod{}, f.defaultInformer)
}

func (f *podInformer) Lister() v1beta1.PodLister {
	return v1beta1.NewPodLister(f.Informer().GetIndexer())
}
