...
import (
	...
	"github.com/pingcap/tidb-operator/tests/pkg/apiserver/client/clientset/versioned/scheme"
...
// ExampleV1alpha1Client is used to interact with features provided by the example.pingcap.com group.
type ExampleV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ExampleV1alpha1Client) Pods(namespace string) PodInterface {
