			...
			ginkgo.Context(fmt.Sprintf("[Version: %s]", version), func() {
				...
				ginkgo.It("should change configurations successfully", func() {
					...
					err = controller.GuaranteedUpdate(genericCli, tc, func() error {
						...
						tc.Spec.PD.CommonComponentSpec.Labels[fixture.ComponentCustomKey] = newValue
						tc.Spec.PD.CommonComponentSpec.Annotations[fixture.ComponentCustomKey] = newValue
						tc.Spec.TiKV.CommonComponentSpec.Labels[fixture.ComponentCustomKey] = newValue
						tc.Spec.TiKV.CommonComponentSpec.Annotations[fixture.ComponentCustomKey] = newValue
						tc.Spec.TiDB.CommonComponentSpec.Labels[fixture.ComponentCustomKey] = newValue
						tc.Spec.TiDB.CommonComponentSpec.Annotations[fixture.ComponentCustomKey] = newValue
