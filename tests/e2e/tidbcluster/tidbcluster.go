...
var _ = ginkgo.Describe("[tidb-operator] TiDBCluster", func() {
	...
	ginkgo.It("TidbMonitor: Deploying and checking monitor", func() {
		...
		tm := fixture.NewTidbMonitor("monitor-data-e2e-monitor-monitor-0", tc.Namespace, tc, true, true)
		...
		pvc, err := c.CoreV1().PersistentVolumeClaims(ns).Get("e2e-monitor-monitor-0", metav1.GetOptions{})
