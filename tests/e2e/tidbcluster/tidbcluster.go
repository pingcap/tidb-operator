...
var _ = ginkgo.Describe("TiDBCluster", func() {
	...
	ginkgo.Context("[Feature: TLS]", func() {
		ginkgo.It("should enable TLS for MySQL Client and between TiDB components", func() {
			...
			source := &tests.SourceTidbClusterConfig{
				Namespace:      ns,
				ClusterName:    tcName,
...
func newBlockWriterPodConfig(cfg *tests.Config, ns, clusterName, password, tcVersion string) tests.BlockWriterConfig {
	return tests.BlockWriterConfig{
		Namespace:   ns,
