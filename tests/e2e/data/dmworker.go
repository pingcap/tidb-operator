...
func NewDMWorkerGroup(ns string, patches ...GroupPatch[*v1alpha1.DMWorkerGroup]) *v1alpha1.DMWorkerGroup {
	dwg := &v1alpha1.DMWorkerGroup{
		ObjectMeta: metav1.ObjectMeta{
			Namespace: ns,
			Name:      defaultDMWorkerGroupName,
		},
		Spec: v1alpha1.DMWorkerGroupSpec{
			...
			Template: v1alpha1.DMWorkerTemplate{
