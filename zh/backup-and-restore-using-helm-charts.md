...
category: how-to
aliases: ['/docs-cn/dev/tidb-in-kubernetes/maintain/backup-and-store/','/docs-cn/stable/tidb-in-kubernetes/maintain/backup-and-store/','/docs-cn/v3.1/tidb-in-kubernetes/maintain/backup-and-store/']
---
