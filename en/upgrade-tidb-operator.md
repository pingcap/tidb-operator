...
3. In the `${HOME}/tidb-operator/v1.2.0-rc.1/values-tidb-operator.yaml` file, modify the `operatorImage` version to the new TiDB Operator version. Merge the customized configuration in the old `values.yaml` file to the `${HOME}/tidb-operator/v1.2.0-rc.1/values-tidb-operator.yaml` file, and then execute `helm upgrade`:
    ...
    If TiDB Operator is successfully upgraded, the expected output is as follows. `v1.2.0-rc.1` represents the desired version of TiDB Operator.
...
3. In the `${HOME}/tidb-operator/v1.2.0-rc.1/values-tidb-operator.yaml` file, modify the `operatorImage` version to the new TiDB Operator version. Merge the customized configuration in the old `values.yaml` file to the `${HOME}/tidb-operator/v1.2.0-rc.1/values-tidb-operator.yaml` file, and then execute `helm upgrade`:
   ...
   If TiDB Operator is successfully upgraded, the expected output is as follows. `v1.2.0-rc.1` represents the new version of TiDB Operator.
