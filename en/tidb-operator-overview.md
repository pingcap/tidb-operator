...
+ [Upgrade TiDB Cluster](upgrade-tidb-cluster.md#upgrade-the-version-of-tidb-cluster)
+ [Change the Configuration of TiDB Cluster](upgrade-tidb-cluster.md#change-the-configuration-of-tidb-cluster)
