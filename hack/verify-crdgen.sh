...
$GOPATH/bin/to-crdgen generate tidbcluster > $crd_verify_target
$GOPATH/bin/to-crdgen generate backup >> $crd_verify_target
$GOPATH/bin/to-crdgen generate restore >> $crd_verify_target
$GOPATH/bin/to-crdgen generate backupschedule >> $crd_verify_target
