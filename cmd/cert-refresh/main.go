...
func init() {
	...
	flag.IntVar(&config.VerifyPeriodDays, "verify-period-days", 365, "Number of days a certificate generated by -x509 is valid for.")
	flag.IntVar(&config.RefreshIntervalDays, "interval-days", 7, "Number of days cert should be refreshed before expired.")
