...
func init() {
	...
	flag.IntVar(&cert_refresh.Days, "verify-period-days", 365, "Number of days a certificate generated by -x509 is valid for.")
	flag.IntVar(&refreshIntervalDays, "interval-days", 7, "Number of days cert should be refreshed before expired.")
	flag.Parse()
...
func main() {
	...
	manager := cert_refresh.NewRefreshManager(kubeCli)

	err = manager.Run(podName, namespace, config)
	if err != nil {
