...
func init() {
	...
	flag.IntVar(&cert_refresh.Days, "verifyPeriodDays", 365, "Number of days a certificate generated by -x509 is valid for.")
	flag.IntVar(&refreshIntervalDays, "intervalDays", 7, "Number of days cert should be refreshed before expired.")
	flag.Parse()
