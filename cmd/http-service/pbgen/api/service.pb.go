...
var file_api_service_proto_rawDesc = []byte{
	...
	0x70, 0x6f, 0x72, 0x74, 0x32, 0xce, 0x03, 0x0a, 0x07, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72,
	...
	,
...
var file_api_service_proto_msgTypes = make([]protoimpl.MessageInfo, 33)
var file_api_service_proto_goTypes = []interface{}{
	...
	nil,                       // 23: api.Component.ConfigEntry
	nil,                       // 24: api.TiFlashComponent.ConfigEntry
	nil,                       // 25: api.TiFlashComponent.LearnerConfigEntry
	nil,                       // 26: api.Grafana.EnvsEntry
	nil,                       // 27: api.PDStatus.ConfigEntry
	nil,                       // 28: api.TiKVStatus.ConfigEntry
	nil,                       // 29: api.TiFlashStatus.ConfigEntry
	nil,                       // 30: api.TiFlashStatus.LearnerConfigEntry
	nil,                       // 31: api.TiDBStatus.ConfigEntry
	nil,                       // 32: api.GrafanaStatus.EnvsEntry
...
var file_api_service_proto_depIdxs = []int32{
	...
	23, // 1: api.Component.config:type_name -> api.Component.ConfigEntry
	1,  // 2: api.TiFlashComponent.resource:type_name -> api.Resource
	24, // 3: api.TiFlashComponent.config:type_name -> api.TiFlashComponent.ConfigEntry
	25, // 4: api.TiFlashComponent.learner_config:type_name -> api.TiFlashComponent.LearnerConfigEntry
	1,  // 5: api.Prometheus.resource:type_name -> api.Resource
	1,  // 6: api.Grafana.resource:type_name -> api.Resource
	26, // 7: api.Grafana.envs:type_name -> api.Grafana.EnvsEntry
	...
	27, // 27: api.PDStatus.config:type_name -> api.PDStatus.ConfigEntry
	14, // 28: api.PDStatus.members:type_name -> api.PDMember
	1,  // 29: api.TiKVStatus.resource:type_name -> api.Resource
	28, // 30: api.TiKVStatus.config:type_name -> api.TiKVStatus.ConfigEntry
	16, // 31: api.TiKVStatus.members:type_name -> api.TiKVMember
	1,  // 32: api.TiFlashStatus.resource:type_name -> api.Resource
	29, // 33: api.TiFlashStatus.config:type_name -> api.TiFlashStatus.ConfigEntry
	30, // 34: api.TiFlashStatus.learner_config:type_name -> api.TiFlashStatus.LearnerConfigEntry
	18, // 35: api.TiFlashStatus.members:type_name -> api.TiFlashMember
	1,  // 36: api.TiDBStatus.resource:type_name -> api.Resource
	31, // 37: api.TiDBStatus.config:type_name -> api.TiDBStatus.ConfigEntry
	...
	32, // 41: api.GrafanaStatus.envs:type_name -> api.GrafanaStatus.EnvsEntry
	33, // 42: api.Component.ConfigEntry.value:type_name -> google.protobuf.Value
	33, // 43: api.TiFlashComponent.ConfigEntry.value:type_name -> google.protobuf.Value
	33, // 44: api.TiFlashComponent.LearnerConfigEntry.value:type_name -> google.protobuf.Value
	33, // 45: api.PDStatus.ConfigEntry.value:type_name -> google.protobuf.Value
	33, // 46: api.TiKVStatus.ConfigEntry.value:type_name -> google.protobuf.Value
	33, // 47: api.TiFlashStatus.ConfigEntry.value:type_name -> google.protobuf.Value
	33, // 48: api.TiFlashStatus.LearnerConfigEntry.value:type_name -> google.protobuf.Value
	33, // 49: api.TiDBStatus.ConfigEntry.value:type_name -> google.protobuf.Value
	...
	7,  // 53: api.Cluster.CreateCluster:output_type -> api.CreateClusterResp
	9,  // 54: api.Cluster.UpdateCluster:output_type -> api.UpdateClusterResp
	11, // 55: api.Cluster.GetCluster:output_type -> api.GetClusterResp
