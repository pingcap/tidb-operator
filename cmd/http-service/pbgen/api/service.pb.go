...
type TiFlashStatus struct {
	...
	Resource *Resource                  `protobuf:"bytes,3,opt,name=resource,proto3" json:"resource,omitempty"`
	Config   map[string]*structpb.Value `protobuf:"bytes,4,rep,name=config,proto3" json:"config,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	Members  []*TiFlashMember           `protobuf:"bytes,5,rep,name=members,proto3" json:"members,omitempty"`
}
...
var file_api_service_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x74, 0x65, 0x22, 0xd1, 0x05, 0x0a, 0x0d, 0x54, 0x69,
	...
	0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x54, 0x69, 0x46, 0x6c,
