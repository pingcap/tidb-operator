...
func NewRestoreCommand() *cobra.Command {
	...
	cmd.Flags().BoolVar(&ro.TLSClient, "tls-client", false, "Whether client tls is enabled")
	cmd.Flags().BoolVar(&ro.TLSCluster, "tls-cluster", false, "Whether cluster tls is enabled")
	return cmd
}
