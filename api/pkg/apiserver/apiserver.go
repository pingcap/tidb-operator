...
import (
	...
	"github.com/pingcap/tidb-operator/api/pkg/apis/wardle/install"
	whiteliststorage "github.com/pingcap/tidb-operator/api/pkg/registry/wardle/whitelist"
...
func (c completedConfig) New() (*WardleServer, error) {
	...
	v1alpha1storage["whitelist"] = whiteliststorage.NewStorage()
