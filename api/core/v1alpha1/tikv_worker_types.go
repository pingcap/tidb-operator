...
// +kubebuilder:resource:categories=group,shortName=kvwg
...
// TiKVWorkerGroup defines a group of similar TiKV worker instances.
...
// TiKVWorker defines a TiKV worker instance.
...
// TiKVWorkerTemplateSpec can only be specified in TiKVWorkerGroup.
...
// TiKVWorkerSpec defines the spec of tikv-worker
