...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TiDBPreStopHook) DeepCopyInto(out *TiDBPreStopHook) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TiDBPreStopHook.
func (in *TiDBPreStopHook) DeepCopy() *TiDBPreStopHook {
	if in == nil {
		return nil
	}
	out := new(TiDBPreStopHook)
	in.DeepCopyInto(out)
	return out
}
