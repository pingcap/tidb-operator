...
type TiDBTemplateSpec struct {
	...
	// PreStopHookSleepSeconds is the seconds to sleep before sending the SIGTERM to the tidb container.
	...
	PreStopHookSleepSeconds *int32 `json:"preStopHookSleepSeconds,omitempty"`
