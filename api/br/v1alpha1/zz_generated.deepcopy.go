...
func (in *TiBRGCOverlay) DeepCopyInto(out *TiBRGCOverlay) {
	*out = *in
	if in.Pods != nil {
		...
		*out = make([]TiBRGCPodOverlay, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *TiBRGCSpec) DeepCopyInto(out *TiBRGCSpec) {
	*out = *in
	...
	in.GCStrategy.DeepCopyInto(&out.GCStrategy)
	if in.Image != nil {
...
func (in *TiBRGCStrategy) DeepCopyInto(out *TiBRGCStrategy) {
	*out = *in
	if in.TieredStrategies != nil {
		in, out := &in.TieredStrategies, &out.TieredStrategies
		*out = make([]TieredStorageStrategy, len(*in))
		copy(*out, *in)
	}
	return
}
...
func (in *TiBRSpec) DeepCopyInto(out *TiBRSpec) {
	*out = *in
	out.Cluster = in.Cluster
	if in.AutoSchedule != nil {
		in, out := &in.AutoSchedule, &out.AutoSchedule
		*out = new(TiBRAutoSchedule)
		**out = **in
	}
	if in.Image != nil {
