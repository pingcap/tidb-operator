...
// FeatureGate is an explicit Cluster feature override.
//
// +k8s:deepcopy-gen=true
type FeatureGate struct {
	Name Feature `json:"name"`

	// Enabled overrides the default for this feature. If omitted, it defaults to true.
	// +optional
	// +kubebuilder:default=true
	Enabled *bool `json:"enabled,omitempty"`
}

// FeatureGateStatus describes the stage of a Cluster feature.
//
// +k8s:deepcopy-gen=true
